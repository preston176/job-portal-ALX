      ...
      <div className='w-full flex flex-col-reverse md:flex-row gap-10 items-center p-5'>
        <div className='w-full md:2/3 2xl:w-2/4'>
          ...
          <p className='text-justify leading-7'>
            Microsoft Corporation Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptatum iusto et debitis, modi temporibus porro. Hic repudiandae libero, facilis, suscipit repellat enim dolorum necessitatibus velit eius blanditiis officiis, voluptatem quae!
          </p>
        </div>
